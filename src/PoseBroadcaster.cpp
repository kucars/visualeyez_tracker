...
void Robot::updateRobotPose()
{
    ...
    Eigen::Vector3d x_axis=(markers_position[1]-markers_position[0]).normalized(); // Heading
    Eigen::Vector3d z_axis=x_axis.cross((markers_position[2]-markers_position[1]).normalized()).normalized();
